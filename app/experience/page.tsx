                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <li className="flex gap-3 p-3 rounded-lg border bg-muted/30">
                    ...
                    <span>
                      ...
                      and packaging, and entire payments automation - from product definition to launch and telemetry to
                  ...
                  <li className="flex gap-3 p-3 rounded-lg border bg-muted/30">
                    ...
                    <span>
                      ...
                      support text, voice, and other modalities so the same agent could be used across chat, voice, and
                      future channels.
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <li className="flex gap-3 p-3 rounded-lg border bg-muted/30">
                    <span className="text-chart-1 mt-1">•</span>
                    <span>
                      <strong className="text-foreground">Achieved 5% conversion</strong> from inbound traffic to paying
                      customers through targeted freemium mechanics and trial-to-paid flows.
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex gap-3 p-3 rounded-lg border bg-muted/30">
                    ...
                    <span>
                      ...
                      <strong className="text-foreground">15+ high-value clients</strong> in Natural Resources and other
                      industries.
                    </span>
                  </li>
                  <li className="flex gap-3 p-3 rounded-lg border bg-muted/30">
          ...
          <div className="pt-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Card className="border-l-4 border-l-chart-3 hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Dissipative particle dynamics to study self-assembly of surfactant molecules. Tools included LAMMPS,
                    VMD and domain-specific simulation stacks.
                  </p>
                </CardContent>
              </Card>
            </div>
