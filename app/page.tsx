...
import { ArrowRight, Sparkles, Target, Brain, TrendingUp, Globe, Code2, BookOpen, Award, Plane, Sparkle, Zap, Rocket, Lightbulb, Wrench, CreditCard } from 'lucide-react'
    ...
    <CellularBackground>
      <div className="min-h-screen">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          {/* Content remains the same, just removing the old gradient background div */}
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-orange-500/20 to-orange-600/20 backdrop-blur-xl px-5 py-2 text-sm border border-orange-500/30 shadow-lg">
              ...
              <span className="font-medium text-white mix-blend-difference">Senior Product Manager - GenAI</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mix-blend-difference drop-shadow-[0_8px_16px_rgba(0,0,0,0.4)]">
              Apoorva Shrivastava
            </h1>
          </div>

          <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 animate-bounce">
            <span className="text-xs text-white/60 font-medium mix-blend-difference">Scroll to explore</span>
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-12">
              <div className="text-center space-y-6 max-w-4xl mx-auto">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed font-light">
                  Product leader shipping AI-empowered products across SaaS enterprise platforms. Pioneered
                  <span className="text-orange-500 font-medium"> user-focused thinking that delivers value to end customers while driving business outcomes</span> at scale.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-6xl mx-auto">
                <Card className="border-2 hover:border-orange-500/50 transition-all hover:shadow-lg group bg-white/60 backdrop-blur-sm">
                ...
                <Card className="border-2 hover:border-orange-500/50 transition-all hover:shadow-lg group bg-white/60 backdrop-blur-sm">
                  <CardContent className="pt-6 pb-6 text-center space-y-2">
                    ...
                    <p className="font-semibold">Payments Automation</p>
                  </CardContent>
                </Card>
              </div>
            </div>
          ...
          <section className="py-16 relative">
            ...
            <div className="relative">
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <Card className="border-2 bg-white/60 backdrop-blur-sm hover:shadow-xl transition-all">
                ...
                <Card className="border-2 bg-white/60 backdrop-blur-sm hover:shadow-xl transition-all">
                  <CardContent className="pt-8 pb-8 text-center">
                    <div className="text-5xl font-bold bg-gradient-to-br from-orange-500 to-orange-600 bg-clip-text text-transparent mb-2">20+</div>
                    <div className="text-sm text-muted-foreground font-medium">Projects Delivered</div>
                  </CardContent>
                </Card>
                <Card className="border-2 bg-white/60 backdrop-blur-sm hover:shadow-xl transition-all">
                  <CardContent className="pt-8 pb-8 text-center">
                    <div className="text-5xl font-bold bg-gradient-to-br from-orange-500 to-orange-600 bg-clip-text text-transparent mb-2">30%</div>
                    <div className="text-sm text-muted-foreground font-medium">Avg. Efficiency Gains</div>
                  </CardContent>
                </Card>
                <Card className="border-2 bg-white/60 backdrop-blur-sm hover:shadow-xl transition-all">
                  <CardContent className="pt-8 pb-8 text-center">
                    <div className="text-5xl font-bold bg-gradient-to-br from-orange-500 to-orange-600 bg-clip-text text-transparent mb-2">2x</div>
                    <div className="text-sm text-muted-foreground font-medium">Feature Adoption Rate</div>
                  </CardContent>
                </Card>
              </div>
            </div>
          ...
          <section className="py-24 relative">
            <div className="space-y-16">
              ...
              <div className="grid md:grid-cols-5 gap-8 items-center max-w-6xl mx-auto">
                <Card className="md:col-span-3 border-2 p-6 bg-white/60 backdrop-blur-sm">
                ...
                <Card className="border-2 bg-white/60 backdrop-blur-sm hover:shadow-xl transition-all">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Badge className="text-xs py-1.5 px-3 bg-orange-500/10 text-orange-600 border-orange-500/30">Antigravity</Badge>
                      <Badge className="text-xs py-1.5 px-3 bg-orange-500/10 text-orange-600 border-orange-500/30">Gamma</Badge>
                      <Badge className="text-xs py-1.5 px-3 bg-gray-100 text-gray-700 border-gray-300">Metabase</Badge>
                      <Badge className="text-xs py-1.5 px-3 bg-gray-100 text-gray-700 border-gray-300">Google Suite</Badge>
                      <Badge className="text-xs py-1.5 px-3 bg-gray-100 text-gray-700 border-gray-300">Microsoft Suite</Badge>
                    </div>
          ...
          <section className="py-24 relative rounded-3xl overflow-hidden my-12">
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-white/50 to-black/5 backdrop-blur-sm" />
          ...
          <section className="py-16 text-center">
            <Button asChild size="lg" className="h-14 px-10 text-lg group bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-xl shadow-orange-500/30">
              <Link href="/projects">
